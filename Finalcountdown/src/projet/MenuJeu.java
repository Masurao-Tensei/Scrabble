...
public class MenuJeu {
	...
	public MenuJeu(Joueur joueur, Sac sac/*int choixaction, int possibilitechoix*/) {
		super();
		this.choixaction = choixaction;
		this.possibilitechoix = possibilitechoix;
	}
	...
	public void actionmenu(int choixaction, Joueur joueur, Sac sac, Plateau plateau){
	...
	public void placermot(Joueur joueur, Sac sac, Plateau plateau, String tab[][]){
	...
	public void ifplateauvidehorizontal(Joueur joueur, Sac sac, Plateau plateau, String tab[][], int x, int y, int[][] valD,Score scorejoueur){
	...
	public void elseplateauvidehorizontal(Joueur joueur, Sac sac, Plateau plateau, String tab[][], int x, int y, int[][] valD,Score scorejoueur){
	...
	public void ifplateauvidevertical(Joueur joueur, Sac sac, Plateau plateau, String tab[][], int x, int y, int[][] valD,Score scorejoueur){
	...
	public void elseplateauvidevertical(Joueur joueur, Sac sac, Plateau plateau, String tab[][], int x, int y, int[][] valD,Score scorejoueur){
	...
	public void annulerderniercouphorizontal(Plateau plateau, String tab[][], int ligne, int colonne, int cpt){
	...
	public void annulerderniercoupvertical(Plateau plateau, String tab[][], int ligne, int colonne, int cpt){
	...
	public void tourjoueur(Sac sac, Joueur joueur, Plateau plateau){
	...
	public void tourjoueur2(Sac sac, Joueur joueur, Plateau plateau){
